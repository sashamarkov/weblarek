...
```
**Назначение:** Описывает структуру товара в каталоге интернет-магазина. Содержит всю необходимую информацию для отображения и работы с товаром.
...
```
Метод `validate()` возвращает объект, где ключи - названия полей, а значения - тексты ошибок. Если поле валидно, оно отсутствует в объекте.
